...
function useRect(nodeRef, initialRect) {
  ...
  var _React$useReducer = import_react5.default.useReducer(rectReducer, initialRect), rect = _React$useReducer[0], dispatch = _React$useReducer[1];
...
function useVirtual(_ref) {
  ...
  var _React$useState = import_react5.default.useState(0), scrollOffset = _React$useState[0], setScrollOffset = _React$useState[1];
  ...
  var _React$useState2 = import_react5.default.useState({}), measuredCache = _React$useState2[0], setMeasuredCache = _React$useState2[1];
  ...
  var indexes = import_react5.default.useMemo(function() {
